...
export default function HeroSection({ shaderKey, onHeightChange }) {
  ...
  return (
    <section ref={containerRef} className="hero-fill" style={{ position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
